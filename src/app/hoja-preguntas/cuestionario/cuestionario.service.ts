...
// - cambiar el numero de preguntas en el html  cabezera
 auditItems:Preguntas[] = [
    ...
    {id: 13.0,
      orden: 3,
    texto: 'En los últimos 12 meses, ¿cuántos TRAGOS de alcohol suele tomar en un día de consumo normal?',
    a1: '1 ó 2',
    a2: '3 ó 4',
    a3: '5 ó 6',
    a4: '7,8 ó 9',
    ...
    {id: 11.0,
      orden: 5,
    texto: 'En los últimos 12 meses, ¿con qué frecuencia ha bebido 4 o más TRAGOS en un mismo día?',
    a1: 'Nunca',
    a2: 'Algunos meses',
    a3: 'Mensualmente',
    a4: 'Semanalmente',
    ...
    {id: 12.0,
      orden: 6,
    texto: 'En los últimos 12 meses, ¿con qué frecuencia ha bebido 3 o más TRAGOS en un mismo día?',
    a1: 'Nunca',
    a2: 'Algunos meses',
    a3: 'Mensualmente',
    a4: 'Semanalmente',
